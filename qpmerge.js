...
const directory = "K:/MEGA/Daily Request - QP/";
...
for (i = 0; i < masterArray.length; i++) {
    if (masterArray[i].length === 3) {
        ...
        merge([file0, file1, file2], (`${masterArray[i][0]}.pdf`), (err) => {
            if (err)
                return console.log(err);
            console.log('Successfully merged!');
        });
